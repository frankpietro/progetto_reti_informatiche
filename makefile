all: ./ds_dir/ds ./peer_dir/peer

./peer_dir/peer: ./peer_dir/peer.o ./util/msg.o ./util/util_c.o ./util/retr_time.o
	gcc -Wall ./peer_dir/peer.o ./util/msg.o ./util/util_c.o ./util/retr_time.o -o ./peer_dir/peer
...
./peer_dir/peer.o: ./peer_dir/peer.c ./util/msg.h ./util/util_c.h
	gcc -Wall -c ./peer_dir/peer.c -o ./peer_dir/peer.o
...
clean:
	rm ./ds_dir/*.o ./ds_dir/ds ./peer_dir/*.o ./peer_dir/peer ./util/*.o
	-mv ./ds_dir/2021* ./logs
	-rm ./ds_dir/*.txt
